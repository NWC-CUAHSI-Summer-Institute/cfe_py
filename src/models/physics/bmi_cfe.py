...
#         lateral_flow_linear_reservoir_constant *= 3600.0                                              # Not used
        ...
        self.volstart = torch.add(self.volstart, self.gw_reservoir['storage_m'])
        ...
        self.volstart = torch.add(self.volstart, self.soil_reservoir['storage_m'])
    ...
    # BMI: Model Control Function
    def update(self):
        self.volin = torch.add(self.volin, self.timestep_rainfall_input_m)
